...
class BillFormPage(MethodView):
    ...
    def post(self):
        ...
        return  render_template('bill_form_page.html', billform =billform,
                                name1=flatmate1.name, result=True,
                               amount1 = round(flatmate1.Pay(the_bill,flatmate2),2),
                                name2=flatmate2.name,
                                amount2= round(flatmate2.Pay(the_bill, flatmate1),2)
                                )
...
class BillForm(Form):
    ...
    days_in_house1 = StringField("Days in the house: ", default="2")
